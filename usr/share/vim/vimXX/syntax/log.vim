...
syn match log_error     '\c\<\(FATAL\|ERROR\|ERRORS\|FAIL\|FAILED\|FAILURE\|EMERG\|ALERT\|CRITICAL\).*'
syn match log_warning   '\c\<\(WARNING\|DELETE\|DELETING\|DELETED\|RETRY\|RETRYING\|WARN\).*'
syn match log_notice    '\c\<\(NOTICE\|INFO\|DEBUG\|TRACE\|SHUTDOWN\|STARTUP\|SEVERE\).'
